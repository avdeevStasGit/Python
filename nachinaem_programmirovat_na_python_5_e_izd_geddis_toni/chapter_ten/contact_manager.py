# Эта программа управляет константами.
...
def get_menu_choice():
    ...
    while choice < LOOK_UP or choice > QUIT:
        choice = int(input('Ведите выбранный пункт: '))

    # Вернуть выбранный пользовавтелем пункт.
    return choice

# Функцмя look_up отыскивает элемент
# в заданном словаре.
...
def add(mycontacts):
    ...
    # Если имя в словваре не существует, то
    # добавить его в качестве ключа со связанным с ним
    # значением в виде оъекта.
...
# Функция save_contact консервирует указанный
