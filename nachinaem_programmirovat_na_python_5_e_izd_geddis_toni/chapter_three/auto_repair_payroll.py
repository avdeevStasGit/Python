...
OT_MULTIOLIER = 1.5 # Коэффициент сверхурочного времени.
...
# Рассчитать и показать заработную платы до удержания.
if hours > BASE_HOURS:
    ...
    # Рассчитать оплату за работу в сверхвурочное время.
